...
##	docs='glutMouseWheelFunc( FUNCTION_TYPE(None, c_int, c_int, c_int, c_int)(callback) ) -> None',
##	argNames=('callback',),
##)
...
##	docs='glutCloseFunc( FUNCTION_TYPE(None)(callback) ) -> None',
##	argNames=('callback',),
##)
...
##	argTypes=[FUNCTION_TYPE(None)],
##	docs='glutWMCloseFunc( FUNCTION_TYPE(None)(callback) ) -> None',
##	argNames=('callback',),
##)
...
##	argTypes=[FUNCTION_TYPE(None)],
##	docs='glutMenuDestroyFunc( FUNCTION_TYPE(None)(callback) ) -> None',
##	argNames=('callback',),
##)

...
Options:
  ...
  --[no-]latex-docs Create (or not) <modulename>module.tex.
                   Default is --no-latex-docs.
  --short-latex    Create 'incomplete' LaTeX document (without commands
                   \\documentclass, \\tableofcontents, and \\begin{document},
                   \\end{document}).

  --[no-]rest-docs Create (or not) <modulename>module.rst.
                   Default is --no-rest-docs.

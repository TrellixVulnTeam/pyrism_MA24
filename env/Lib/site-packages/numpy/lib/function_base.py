...
class vectorize(object):
    """
    vectorize(pyfunc, otypes=None, docs=None, excluded=None, cache=False,
              signature=None)
    ...
    >>> vfunc.__doc__
    'Return a-b if a>b, otherwise return a+b'
    >>> vfunc = np.vectorize(myfunc, docs='Vectorized `myfunc`')
    >>> vfunc.__doc__
    'Vectorized `myfunc`'
    ...
    .. [1] NumPy Reference, section `Generalized Universal Function API
           <http://docs.scipy.org/docs/numpy/reference/c-api.generalized-ufuncs.html>`_.
    """
...
def add_newdoc(place, obj, doc):
    ...
    If docs is a string add it to obj as a docstring

    If docs is a tuple, then the first element is interpreted as
       an attribute of obj and the second as the docstring
          (method, docstring)

    If docs is a list, then each element of the list should be a
